...
final class ChallengeService {
    ...
    func completeTask(taskID: Int, occurrenceDate: String, photoPath: String? = nil) async throws {
        let _: CompletionResponseDTO = try await client.post("completions", body: CompleteTaskRequest(taskId: taskID, occurrenceDate: occurrenceDate, photoPath: photoPath))
    }
